create table account (id int not null, amount int not null, discount boolean not null, 
					  membership_card_id int, worker_id int, primary key (id));
...
create table book (id int4 not null, cover varchar(255), description varchar(255), language varchar(255), 
				   number_of_pages int4 not null, price int4 not null, quantity int4 not null, title varchar(255), 
				   author_id int4, publishing_house_id int4, primary key (id));
...
create table book_awards (id int4 not null, place varchar(255), year varchar(255), award_id int4 not null, 
						  book_id int4 not null, primary key (id));
create table genre (id int4 not null, name varchar(255), primary key (id));
create table membership_card (id int4 not null, address varchar(255), date timestamp, email varchar(255), 
							  expire_date timestamp, first_name varchar(255), last_name varchar(255), 
							  phone varchar(255), serial_number int4 not null, unique_number varchar(255), primary key (id));
create table publishing_house (id int4 not null, location varchar(255), name varchar(255), primary key (id));
create table worker (id int4 not null, address varchar(255), date_of_birth timestamp, email varchar(255), 
					 first_name varchar(255), last_name varchar(255), phone varchar(255), 
					 unique_number varchar(255), primary key (id));
